            ...
            <Card.Body>
                <blockquote className="blockquote mb-0">
                    <p style={{ textAlign: "justify" }}>
                        We are  <span className="purple">Bright Angel Education Centre </span>
                        Located at <span className="purple"> Mulago , Kampala-Uganda. P.o.Box 235 kampala-Uganda<br/>Email-brightangel@gmail.com</span>
